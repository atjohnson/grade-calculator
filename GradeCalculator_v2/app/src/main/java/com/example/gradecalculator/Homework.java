...
public class Homework extends AppCompatActivity implements View.OnClickListener {
    ...
    {
        int i = 0; //counter
        double sum = 0, sectionGrade = 0, overallGrade = 0, temp = 0;
        ...
        quizScreen.putExtra(TAG_HW_GRADE, sectionGrade);
        quizScreen.putExtra(TAG_HW_TOTAL, overallGrade);
